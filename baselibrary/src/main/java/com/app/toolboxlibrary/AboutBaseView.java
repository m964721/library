...
public class AboutBaseView {
    ...
    public static View getLayoutView(Context context,String  layoutname,ViewGroup rootView){
        ...
        return inflater.inflate(AboutBaseView.getViewId(context,"layout",layoutname),rootView);
    }
    ...
    public static int getAttrId(Context context ,String name){
        int id =  AboutBaseView.getViewId(context,"styleable",name);
        return id;
    }
    ...
    public static int getAnimId(Context context ,String name){
        int id =  AboutBaseView.getViewId(context,"anim",name);
        return id;
    }
}
