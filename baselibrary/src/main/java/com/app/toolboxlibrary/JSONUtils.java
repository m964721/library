...
public class JSONUtils {
     ...
     */
    @SuppressLint("NewApi")
    public static JSONArray filterByJsonArrayFieldValue(JSONArray destArray, String fieldName, String byValue) throws JSONException {
     ...
     */
    @SuppressLint("NewApi")
    public static JSONArray deleteByJsonArrayField(JSONArray destArray, String fieldName, JSONArray deleteArray) throws JSONException {
